...
#PBS -j oe
#PBS -q workq
#PBS -o /lustre/scratch/users/michael.schon/log/170129_rsem/rsem-rna_^array_index^_mapping.log
...
rsem_ref_dir=/lustre/scratch/users/$USER/indices/rsem/$aligner/Araport11
...
# --solexa-quals only for 8cell pilot samples
rsem_params="--$aligner \
--num-threads $threads \
